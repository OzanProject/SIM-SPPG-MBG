            ...
            <div class="col-lg-4">
                ...
                <div class="card border-0 shadow-lg text-center" style="border-radius: 20px;">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mt-3">
                            <a href="{{ config('app.url') . $invoice->payment_proof }}" target="_blank" class="btn btn-sm btn-outline-info rounded-pill">
                ...
                <div class="card border-0 shadow-sm mt-3" style="border-radius:15px;">
                    <div class="card-body p-3 text-center">
                        ...
                        <a href="{{ config('app.url') . $invoice->payment_proof }}" target="_blank">
                             <img src="{{ config('app.url') . $invoice->payment_proof }}" class="img-fluid rounded border shadow-inner" style="max-height: 100px;">
                        </a>
                    </div>
                </div>
                @endif
