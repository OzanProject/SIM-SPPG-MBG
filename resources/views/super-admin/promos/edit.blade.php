...
<div class="content-header pt-3 pb-2">
    <div class="container-fluid">
        <div class="row align-items-center mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark font-weight-bold" style="font-size: 1.8rem;">Edit Kode Promo</h1>
            </div>
            <div class="col-sm-6">
        ...
        <div class="card card-primary card-outline shadow-sm" style="max-width: 820px; margin: 0 auto;">
            <div class="card-header border-bottom-0">
                <h3 class="card-title font-weight-bold text-dark">
                    ...
                    Perbarui Data Kode Promo: <span class="text-primary">{{ $promo->code }}</span>
                </h3>
            </div>
            <div class="card-body">
                ...
                <div class="alert alert-light border d-flex align-items-center mb-4 py-2">
                    <i class="fas fa-chart-bar text-primary mr-3" style="font-size: 1.3rem;"></i>
                    <div>
                        <strong>Pemakaian saat ini:</strong> {{ $promo->used_count }} dari {{ $promo->max_uses }} kuota (sisa {{ $promo->remaining_uses }}).
                        &nbsp;|&nbsp; Dibuat: {{ $promo->created_at->format('d M Y') }}
                    </div>
                </div>

                <form action="{{ url('/super-admin/promos/' . $promo->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-4">
                                ...
                                <input type="text" name="code" class="form-control text-uppercase font-weight-bold @error('code') is-invalid @enderror"
                                    value="{{ old('code', $promo->code) }}" required style="letter-spacing: 2px;">
                        ...
                        <div class="col-md-3">
                            <div class="form-group mb-4">
                                <label class="font-weight-bold text-dark">Nilai <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-white font-weight-bold" id="valuePrefix">Rp</span>
                                    </div>
                                    <input type="number" min="0" name="value" class="form-control @error('value') is-invalid @enderror" value="{{ old('value', (int)$promo->value) }}" required>
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group mb-4">
                                ...
                                <input type="date" name="starts_at" class="form-control @error('starts_at') is-invalid @enderror" value="{{ old('starts_at', $promo->starts_at->format('Y-m-d')) }}" required>
                        ...
                        <div class="col-md-5">
                            <div class="form-group mb-4">
                                ...
                                <input type="date" name="ends_at" class="form-control @error('ends_at') is-invalid @enderror" value="{{ old('ends_at', $promo->ends_at->format('Y-m-d')) }}" required>
                        ...
                        <div class="col-md-2">
                            <div class="form-group mb-4">
                                ...
                                <input type="number" min="{{ $promo->used_count }}" name="max_uses" class="form-control @error('max_uses') is-invalid @enderror" value="{{ old('max_uses', $promo->max_uses) }}" required>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="row mt-2">
                                ...
                                <div class="col-md-3 col-sm-6 mb-2">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="plan_{{ $plan->id }}"
                                            ...
                                            {{ in_array($plan->id, old('subscription_plan_ids', $selectedPlanIds)) ? 'checked' : '' }}>
                            ...
                            @empty
                                <div class="col-12 text-muted"><i>Belum ada paket aktif.</i></div>
                            @endforelse
                        </div>
                        <small class="text-muted mt-1 d-block"><i class="fas fa-info-circle mr-1"></i> Tidak ada yang dipilih = berlaku untuk <strong>semua paket</strong>.</small>
                    </div>

                    <div class="form-group mb-5">
                        <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" {{ $promo->is_active ? 'checked' : '' }}>
                            <label class="custom-control-label text-dark" for="is_active">Aktif & Berlaku</label>
                        </div>
                    </div>
